...
#include "TStats.h"  // added by Ra'ed
...
SC_MODULE(TProcessingElement)
{
  ...
  sc_in<int>          PEthrot_level;   //The throttling level from the router <Nizar>
  ...
  double        	   getPower();    // added by Ra'ed
