...
*/
#define PWR_ROUTING                 2.1167e-011/5  //(i/p buffer read+ crossbar+ sw arbiter)     //2.36e-12
...
#define PWR_FORWARD_FLIT           5*2.1167e-011  //(i/p buffer read+ crossbar+ sw arbiter)
#define PWR_LINK                   5.1000e-012
#define PWR_V_LINK            	   2*(3.7177e-013 + 2.1167e-011)   // (vertical link + forward)   

#define PWR_CORE_FLIT              0
// Added by Ra'ed
#define PWR_KILLING_FLIT           0

#define PWR_INCOMING               2*2.1167e-013    //5*2.5272e-012
#define PWR_CLOCKING               1.2924e-011/5
#define PWR_STANDBY                1.2628e-011/5
