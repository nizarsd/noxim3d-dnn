...
\begin{itemize}
\item a cross-layer design-space exploration for IMC-based DNN
      accelerators, spanning the packing, mapping and routing layers,
      in which each layer is evaluated for its own effect and for the
      constraints it imposes downstream;
