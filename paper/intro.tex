...
\item identifying conditional couplings between adjacent layers: delay depends on mapping only above the packing-set floor, the selection policy's gain, including its sign is determined by mapping; 
