#!/usr/bin/env bash
# Does DP's greedy skip-if-busy explain its win, or is it the static ranking? -- ls 0.028.
#
...
# against the stock binary at ls 0.028, and prints a paired comparison against the
...
print(f"\nls 0.028, interior placement, ci 648, n={n} paired seeds\n")
